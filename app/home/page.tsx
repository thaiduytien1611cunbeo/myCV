    ...
    <Card className="pb-3 px-12">
      ...
      <CardBody>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="w-full py-1 px-5 flex shadow-none bg-orange-100 justify-start">
          ...
          <Card className="w-full py-1 px-5 flex shadow-none bg-cyan-100 justify-start">
